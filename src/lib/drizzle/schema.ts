...
export const serviceTypeEnum = pgEnum('service_type', ['Mechanic', 'Towing', 'CarWash', 'Emergency', 'Fuel']);

export const requestStatusEnum = pgEnum('request_status', ['Pending', 'Accepted', 'Completed', 'Cancelled']);
